...
$message .= "<tbody>
       ...
       <tr>
       <td colspan='4' style='padding:2px;'>
         <p style='font-size:20px;'>Date : <b>".$date."</b></p>
       </td>
       </tr>
       <tr>
       <td colspan='4' style='padding:2px;'>
         <p style='font-size:20px;'>Grade : <b>".$grade."</b></p>
       </td>
       </tr>
       
       <tr>
       <td colspan='4' style='padding:2px;'>
         <p style='font-size:20px;'>Time : <b>".$time."</b></p>
       </td>
       </tr>
...
else
{
 ...
 $mail->Port = 587;
             ...
             $mail->setfrom('valleyg538@gmail.com', 'Campus');             
